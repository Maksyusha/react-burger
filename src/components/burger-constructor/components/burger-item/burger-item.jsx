...
import {DELETE_CHOSEN_INGREDIENT, SORT_CHOSEN_INGREDIENTS} from '../../../../services/actions/burger-constructor'
...
export function BurgerItem({item, index}) {
  ...
  const [, dropRef] = useDrop({
    ...
    hover(item, monitor) {
      ...
      dispatch({type: SORT_CHOSEN_INGREDIENTS, dragIndex: dragIndex, hoverIndex: hoverIndex})
  ...
  return (
    <li ref={ref} className={`${itemStyles['burger-item']}`} style={{opacity}}>
